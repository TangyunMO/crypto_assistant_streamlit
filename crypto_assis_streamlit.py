...
if len(avalable_coins) > 0:
    ...
    coin_1 = col1.selectbox("Please choose your coin1:", avalable_coins, 2)
    ...
    # col1, col2, col3 = st.columns(3)
    coin_2 = col1.selectbox("Please choose your coin2:", avalable_coins, 5)
    if coin_2 == coin_1:
    ...
    # col1, col2, col3 = st.columns(3)
    coin_3 = col1.selectbox("Please choose your coin3:", avalable_coins, 1)
